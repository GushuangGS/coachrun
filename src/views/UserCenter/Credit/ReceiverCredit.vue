...
<script>
    ...
    export default{
        ...
        created(){
            ...
            //判断编辑或添加
            this.creditName = this.$store.state.creditName!=""?this.$store.state.creditName:localStorage.getItem("creditName");
            if(this.creditName=='edit'){
                ...
                // console.log(this.ruleForm.month)
